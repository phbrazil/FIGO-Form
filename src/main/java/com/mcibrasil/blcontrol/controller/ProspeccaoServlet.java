...
import com.mcibrasil.blcontrol.model.Prospeccao;
 ...
 */
@WebServlet(name = "ProspeccaoServlet", urlPatterns = {"/ProspeccaoServlet"})
public class ProspeccaoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Prospeccao prospeccao = new Prospeccao(nomecliente, businessmanager, accountmanager, creator, questao1, questao2, questao3, questao4, questao5, questao6, questao7, questao8, questao9, questao10, questao11);

        com.mcibrasil.blcontrol.dao.ProspeccaoDAO gravarproscpec = new com.mcibrasil.blcontrol.dao.ProspeccaoDAO();

        gravarproscpec.GravarProspeccao(prospeccao);
