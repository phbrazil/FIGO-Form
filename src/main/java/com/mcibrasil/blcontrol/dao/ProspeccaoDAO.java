...
public class ProspeccaoDAO {
    ...
    public ResultSet PesquisarProspeccaoGeral() {
        ...
        try {
            ...
            selectgeral = "select * from prospeccao order by creator";
    ...
    public void GravarProspeccao(com.mcibrasil.blcontrol.model.Prospeccao prospeccao) {
        ...
        try {
            ...
            String query = ("INSERT INTO prospeccao (nomecliente, businessmanager,accountmanager,"
