...
public class Prospeccao {
    ...
    public float getQuestao1() {
        return questao1;
    }

    public void setQuestao1(float questao1) {
    ...
    public float getQuestao9() {
        return questao9;
    }

    public void setQuestao9(float questao9) {
    ...
    public Prospeccao(String nomecliente, String businessmanager, String accountmanager, String creator,
