 ...
 */
package com.mcibrasil.dao.FIGOCompanyInformation;
...
public class FIGOCompanyInformation {
    ...
    public boolean GravarFIGOCompanyInformation(com.mcibrasil.model.FIGOCompanyInformation.FIGOCompanyInformation companyinformation) {
