...
<html>
    ...
    <body id="page-top">
        ...
        <form name = "CadastrarSuspect" action="${pageContext.request.contextPath}/SuspectsServlet" method="POST">
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-3">
                            <label>Eventos</label>
                            <select name = "eventos" class="custom-select d-block w-100" id="eventos"  required>
                            ...
                            <div class="invalid-feedback">
                                Favor selecionar Eventos..
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label>Incentivos</label>
                            <select name = "incentivos" class="custom-select d-block w-100" id="incentivos"  required>
                                <option>Selecionar...</option>
                                <option>Sim</option>
                                <option>Não</option>
                            </select>
    ...
    <script>
        ...
        if (mensagem == "Suspect Cadastrado") {
            alert(mensagem)
